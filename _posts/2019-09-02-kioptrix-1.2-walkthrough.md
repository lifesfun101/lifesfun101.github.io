...
Kioptrix level 3 is yet another penetration challenge. This particular machine is vulnerable to Remote Command Execution (RCE), SQL Credential stored in plaintext, weak passwords and a text editor running with administrative credentials.

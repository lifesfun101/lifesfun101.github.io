...
date: 2019-12-07 00:00:00 -0500
categories: [Pentesting, VulnHub]
tags: [vulnhub, enumeration, ftp, web-exploitation, privilege-escalation]
---
...
![](https://github.com/lifesfun101/Offensive-Security/blob/master/Walkthroughs/djinn/media/5f62c8b354ba7836e4e096259caf75e6.png?raw=true)

/wish page

This page hints onto possible command injection.

![](https://github.com/lifesfun101/Offensive-Security/blob/master/Walkthroughs/djinn/media/5dc8d1e5c69b49d5cb0d994ffdb3364c.png?raw=true)

Attempting command injection by typing whoami and pressing Submit.

![](https://github.com/lifesfun101/Offensive-Security/blob/master/Walkthroughs/djinn/media/959326f2c2ecc9723480113c200cc4a0.png?raw=true)
...
![](https://github.com/lifesfun101/Offensive-Security/blob/master/Walkthroughs/djinn/media/d0909dff79983f3350a2c30561877c22.png?raw=true)
...
Considering that the app.py was written in python, I thought that port 1337 app might be written in python too. 

After a little bit of digging I found this article,
https://ctf-wiki.github.io/ctf-wiki/pwn/linux/sandbox/python-sandbox-escape/ .

First, let's start with something easy - whoami, as it turns out the program was
...
Once downloaded uncompyle6 python tool was used to decompile the file,
